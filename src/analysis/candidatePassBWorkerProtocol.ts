/** Google AI's official Gemini 3.6 Flash model identifier. */
export const CANDIDATE_PASS_B_MODEL_ID = "gemini-3.6-flash" as const;
export const CANDIDATE_PASS_B_MODEL_REVISION = "3.6-flash-07-2026" as const;
